        ...
        override public int UpdateItemValue(AidIfxItemStatus item)
        {
            ...
            if (quantity == 2)
            {
                if (byteSequence == "" && wordSequence == "") // //byte sequence defined at the local level
                    ...
                    if ((mostSignificantByte == "" && mostSignificantWord == "") || (mostSignificantByte == "true" && mostSignificantWord == "") || (mostSignificantByte == "" && mostSignificantWord == "true") || (mostSignificantByte == "true" && mostSignificantWord == "true"))
                    {
                        //use default, byte == true and word  == true (Big endian and no word swapping)
                    }
                    else if ((mostSignificantByte == "" && mostSignificantWord == "false") || (mostSignificantByte == "true" && mostSignificantWord == "false"))
                    {
                        //big endian wordswap AABBCCDD => CCDDAABB
                        od[3] = id[1]; od[2] = id[0]; od[1] = id[3]; od[0] = id[2];
                    }
                    else if ((mostSignificantByte == "false" && mostSignificantWord == "true") || (mostSignificantByte == "false" && mostSignificantWord == ""))
                    {
                ...
                //byte sequence defined at the global level
                else if ((byteSequence == "true" && wordSequence == "") || (byteSequence == "" && wordSequence == "true") || (byteSequence == "true" && wordSequence == "true"))
                    {
                        //use default, byte == true and word  == true (Big endian and no word swapping)
                    }

                //byte sequence defined at the global level
                else if ((byteSequence == "true" && wordSequence == "false") || (byteSequence == "" && wordSequence == "false"))
                    {
                        //big endian wordswap AABBCCDD => CCDDAABB
                        od[3] = id[1]; od[2] = id[0]; od[1] = id[3]; od[0] = id[2];
                    }
                ...
                //byte sequence defined at the global level
                else if ((byteSequence == "false" && wordSequence == "true") || (byteSequence == "false" && wordSequence == ""))
                    {
            ...
            //var mbtp = item.FormData.Modv_type?.ToLower().Trim();

            // no definition for long, byte, unsignedbyte, boolean, decimal, unsignedlong, and hexbinary yet
            var strval = "";
