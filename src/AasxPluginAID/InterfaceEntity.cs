                                ...
                                foreach (var propertyElem in propertySMC.Value)
                                {
                                    if (propertyElem.IdShort == "forms")
                                    {
                                        ...
                                        //{
                                            ...
                                            {
                                                if (form.IdShort == "htv_methodName")
                                                {
                                                    protocolType = "HTTP";
                                                    break;
                                                }
                                                else if (idtaDef.mqttFormElemList.Contains(form.IdShort))
                                                {
                                                    protocolType = "MQTT";
                                                    break;
                                                }
                                                else if (idtaDef.modvFormElemList.Contains(form.IdShort))
                                                {
                                                    protocolType = "MODBUS";
                                                    break;
                                                }
                                            ...
                                            foreach (var form in formsSMC.Value)
                                            {
                                                if (form.IdShort == "contentType")
                                                {
                                                    contentype = (form as Aas.Property).Value.ToString();
                                                    break;
                                                }
                                            }
                                        break;
