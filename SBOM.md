...
Project 'AasxIntegrationBase' has the following package references
   [net6.0]: 
   Top-level Package      Requested   Resolved
   > Newtonsoft.Json      13.0.3      13.0.3  
...
Project 'AasxPluginBomStructure' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package                   Requested   Resolved
...
Project 'AasxIntegrationBaseWpf' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package                      Requested   Resolved
   > ExhaustiveMatching.Analyzer          0.5.0       0.5.0   
...
Project 'AasxOpenidClient' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package                      Requested   Resolved
...
Project 'AasxCsharpLibrary.Tests' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package           Requested    Resolved  
...
Project 'WpfMtpControl' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package                       Requested    Resolved  
   > Aml.Engine                            2.0.9        2.0.9     
   > Newtonsoft.Json                       13.0.3       13.0.3    
...
Project 'AasxPluginMtpViewer' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package      Requested   Resolved
   > Newtonsoft.Json      13.0.3      13.0.3  
...
Project 'WpfMtpVisuViewer' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package      Requested   Resolved
   > Newtonsoft.Json      13.0.3      13.0.3  
...
Project 'AasxUaNetServer' has the following package references
   [net6.0]: 
   Top-level Package                       Requested    Resolved  
   > Newtonsoft.Json                       13.0.3       13.0.3    
...
Project 'AasxPluginUaNetServer' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package                       Requested    Resolved  
   > Newtonsoft.Json                       13.0.3       13.0.3    
   > OPCFoundation.NetStandard.Opc.Ua      1.4.371.96   1.4.371.96
...
Project 'AasxPluginUaNetClient' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package                               Requested    Resolved  
   > Newtonsoft.Json                               13.0.3       13.0.3    
   > OPCFoundation.NetStandard.Opc.Ua              1.4.371.96   1.4.371.96
...
Project 'AasxUaNetConsoleServer' has the following package references
   [net6.0]: 
   Top-level Package                       Requested    Resolved  
   > OPCFoundation.NetStandard.Opc.Ua      1.4.371.96   1.4.371.96
...
Project 'WpfXamlTool' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package      Requested   Resolved
   > AvalonEdit           6.1.3.50    6.1.3.50

Project 'AasxPluginImageMap' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package            Requested   Resolved
   > JetBrains.Annotations      2022.1.0    2022.1.0
   > Newtonsoft.Json            13.0.3      13.0.3  
...
Project 'AasxToolkit.Tests' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package             Requested   Resolved
...
Project 'AasxPackageExplorer.GuiTests' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package        Requested   Resolved
...
Project 'AasxPluginAdvancedTextEditor' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package      Requested   Resolved
   > AvalonEdit           6.2.0.78    6.2.0.78
...
Project 'AasxPackageExplorer.Tests' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package        Requested   Resolved
   > NUnit                  3.13.3      3.13.3  
   > NUnit3TestAdapter      4.2.1       4.2.1   
...
Project 'AasxPluginPlotting' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package      Requested   Resolved
   > Newtonsoft.Json      13.0.3      13.0.3  
...
Project 'AasxFormatCst' has the following package references
   [net6.0]: 
   Top-level Package            Requested   Resolved
   > JetBrains.Annotations      2022.1.0    2022.1.0
   > Newtonsoft.Json            13.0.3      13.0.3  
...
Project 'AasxPluginSmdExporter' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package                             Requested   Resolved
...
Project 'AasxPackageLogic' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package                      Requested   Resolved
   > IdentityModel                        6.0.0       6.0.0   
   > jose-jwt                             4.0.1       4.0.1   
...
Project 'AnyUi' has the following package references
   [net6.0]: 
   Transitive Package                         Resolved
   > JetBrains.Annotations                    2022.1.0
   > Microsoft.CSharp                         4.3.0   
...
Project 'BlazorUI' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package               Requested   Resolved
...
Project 'SSIExtension' has the following package references
   [net6.0]: No packages were found for this framework.
Project 'AasxPluginKnownSubmodels' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package            Requested   Resolved
   > JetBrains.Annotations      2022.1.0    2022.1.0
   > Newtonsoft.Json            13.0.3      13.0.3  
...
Project 'UIComponents.Flags.Blazor' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package                          Requested   Resolved
...
Project 'AasxIntegrationBaseGdi' has the following package references
   [net6.0-windows7.0]: 
   Top-level Package            Requested   Resolved
...
Project 'AasxFileServerRestLibrary' has the following package references
   [net6.0]: 
   Top-level Package                             Requested   Resolved
...
Project 'AasxBammRdfImExport' has the following package references
   [net6.0]: 
   Top-level Package            Requested   Resolved
   > dotNetRDF                  2.7.5       2.7.5   
   > JetBrains.Annotations      2022.1.0    2022.1.0
...
Project 'jsoncanonicalizer' has the following package references
   [net6.0]: No packages were found for this framework.
Project 'es6numberserializer' has the following package references
   [net6.0]: No packages were found for this framework.
Project 'AasxSchemaExport' has the following package references
   [net6.0]: 
   Top-level Package            Requested   Resolved
   > JetBrains.Annotations      2022.1.0    2022.1.0
   > Newtonsoft.Json            13.0.3      13.0.3  
